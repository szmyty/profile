  ...
  try {
    ...
    if (axios.isAxiosError(error)) {
      ...
      if (axiosError.response) {
        ...
        console.warn(`Failed to fetch ${path}: ${axiosError.response.status} ${axiosError.response.statusText}`);
        ...
        console.error(`No response received for ${path}:`, axiosError.message);
      } else {
        // Error in setting up the request
        console.error(`Error setting up request for ${path}:`, axiosError.message);
      }
